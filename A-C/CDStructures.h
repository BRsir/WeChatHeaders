...
struct TXCAudioEffector {
    CDUnknownFunctionPointerType *_vptr$TXCAudioEffector;
...
struct TXCPlayProcessor {
    CDUnknownFunctionPointerType *_field1;
    int _field2;
    _Bool _field3;
    _Bool _field4;
    struct TXCAudioCodec *_field5;
    struct TXCAudioJitterBuffer *_field6;
    int _field7;
    int _field8;
    _Bool _field9;
    int _field10;
