...
@interface WCPayJSApiVerifyPayPasswordControlLogic : WCPayControlLogic <WCPayNewPwdViewControllerDelegate, WCPayPayPwdViewControllerDelegate, WCPayVerifyPayCardViewControllerDelegate>
{
    JSEvent *m_jsEvent;
