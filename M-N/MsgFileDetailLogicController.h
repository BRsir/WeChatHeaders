...
@class CMessageWrap, NSString, ShareDataToOpenSDKController, WCScheduleLogicController;

@interface MsgFileDetailLogicController : FileDetailLogicController <IMsgExt, IEnterpriseMsgExt, IMsgRevokeExt, MMAppAttachFileMgrExt, WCScheduleLogicControllerDelegate>
{
