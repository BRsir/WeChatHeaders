...
@class NSString, TXCAudioPlayer, TXCAudioReader, TXSAudioPacket;

@interface TXCMixPlayer : NSObject <TXIAudioPlayDelegate>
{
    struct TXCAudioSpeeder *_audioReadSpeeder;
    TXCAudioPlayer *_player;
    ...
    char *_hasReadPcmCache;
    unsigned long long _hasReadPcmCacheLen;
    _Bool _readCache;
    _Bool _isCache;
    _Bool _isStart;
    _Bool _isPause;
...
- (int)mixDataInternalWithCache:(char *)arg1 withLen:(int)arg2;
- (int)mixDataInternalWithDec:(char *)arg1 withLen:(int)arg2;
...
- (_Bool)pauseMixPlay;
- (_Bool)stopMixPlay;
- (_Bool)startMixPlayForStream:(id)arg1 withDesInfo:(id)arg2 playMix:(_Bool)arg3;
