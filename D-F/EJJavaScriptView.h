...
@class CADisplayLink, EAGLContext, EJCanvasContext, EJCanvasContext<EJPresentable>, EJClassLoader, EJFileSystem, EJFontCache, EJNonRetainingProxy, EJRenderTriggerCollection, EJSharedOpenALManager, EJSharedOpenGLContext, EJSharedTextureCache, EJTimerCollection, NSMutableArray, NSObject<EJDeviceMotionDelegate>, NSObject<EJTouchDelegate>, NSObject<EJWindowEventsDelegate>, NSOperationQueue, NSString;
