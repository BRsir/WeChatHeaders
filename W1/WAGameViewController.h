...
@class NSMutableArray, NSString, NSURLRequest, RCDraggableButton, UILabel, UIView, WAGameActionSheet, WAOpenGLView, YYWAWebView;
...
+ (id)createWhatsNewLoadingView:(id)arg1 inView:(id)arg2;
