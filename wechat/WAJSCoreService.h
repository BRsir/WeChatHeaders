...
@interface WAJSCoreService : NSObject <WAGameContextDelegate, WAJSEventHandlerContextDelegate>
{
...
- (void)endWithResult:(id)arg1 handler:(id)arg2 callbackID:(unsigned int)arg3 isFromIsolatedContext:(_Bool)arg4;
...
- (void)setupAPIBlock:(id)arg1 isFromIsolatedContext:(_Bool)arg2;
- (void)injectJSBaseForAppBrandThread:(id)arg1 wrapScript:(id)arg2 fromPreload:(_Bool)arg3;
- (void)reportJSErrorOnIsolatedContext:(id)arg1;
